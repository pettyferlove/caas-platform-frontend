<template>
  <v-card v-bind="$attrs" :class="classes" class="v-card--material pa-3">
    <div class="d-flex grow flex-wrap">
      ...
      <div
        v-if="$slots['reveal-actions']"
        class="text-center py-0 mt-n12 col col-12"
      >
  ...
  computed: {
    classes() {
      return {
        ...
        "v-card--material--hover-reveal": this.HasRevealActions,
      };
    },
    hasHeading() {
    ...
    HasRevealActions() {
      return Boolean(this.$slots["reveal-actions"]);
    },
  },
};
</script>
