<template>
  <v-row>
    <v-col cols="12" lg="4">
      <material-chart-card
        :data="clusterCPUChart.data"
        :options="clusterCPUChart.options"
        :responsive-options="clusterCPUChart.responsiveOptions"
        color="#E91E63"
        hover-reveal
        type="Bar"
      >
        ...
        <h4 class="card-title font-weight-light mt-2 ml-2">集群CPU使用情况</h4>
